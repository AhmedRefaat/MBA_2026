...
<br>
  ...
  <summary>Table with colors</summary>
    ...
    | | Revenues | | $20,000||
    | 5 | Cash | $5,000 | | Get from Cash: `Credit Cash`<br> Collect Cash (increase Cash): `Debit Cash`|
    | | Account-Receivable | | $5,000| provide invoices means *Account-Receivable(AR)* increases (`debit`).<br>However, collecting cash decreases *AR* (`credit`)|
    | 6 | Equipement | $70,000 | | This is what we received so we `Debit` it.<br>Equipments is **Assets-CapEx**|
    | | Cash | | $70,000 ||
    | 7 | Inventory<br>`Assets`  | | $40,000 | When purchasing Goods that you will sell it *later*, then it is called *Inventory* not *Supplies*, but still <span style="background-color: Green;">Assets</span><br>However, Once the Goods is used in Business operations, then it is called <span style="background-color: Red;">*Expenses*</span>|
