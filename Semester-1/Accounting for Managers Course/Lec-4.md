...
* Consider that we have *Income-Statement* for 2024 shows that we have `Profit = 10M`, so we need to check that the Owns/Shareholder **Dividends - توزيعات الأرباح**.
  ...
  * <ins>**Ex-1**</ins>: 
  <br>
    ...
    <img src="Figures/Lec-4/Ex-1.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
...
<br>
    <img src="Figures/Lec-4/CSA-VA.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
  ...
  * The Generated <ins>**Net-Income (Net-Profit)**</ins> in the end of the report is called: <ins>***Margin***</ins>
    ...
    <img src="Figures/Lec-4/Profit-margin.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
  ...
  * Meanwhile, there is another value called ***<ins>Gorss-Margin-Ratio</ins>***
    <img src="Figures/Lec-4/GrossMarginRatio.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
...
<br>
    <img src="Figures/Lec-4/CSA-HA.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
...
* **Comprehensive-Income الدخل الشامل**: 
  > Bypass Net-Income: means that they are not considered as Net-Income because the item miss one of the Net-Income criteria (i.e, realized)
    ...
    <img src="Figures/Lec-4/OCI.png" alt="Single Step" width="60%" style="border: 3px solid #4a90d9; border-radius: 10px; padding: 6px; box-shadow: 0 4px 12px rgba(7, 167, 225, 0.63);">
