...
* **Goal-Settings Approaches**
  * *Traditional Goal Settings*
    ...
    * Disadvantage:
      * ![disadvantage](Images/Disadv-Tranditional-Goals.png)
  * *Management by Objective (MBO)*
    ...
    * Advantage of MBO and how to split
      * ![MBO-Advantage](Images/MBO-Advantage.png)
...
![Type of Plans](Images/TypesOfPlans.png)
...
![Breadth-Plan](Images/Breadth-Plan.png)
...
graph TD
    ...
    W -->|"defines"| WH["WHAT + HOW\n= Actionable Tasks"]
    H -->|"defines"| WH
    WH -->|"scheduled into"| WHT["WHAT + HOW + WHEN\n= ✅ SPECIFIC PLAN"]
    T -->|"defines"| HT["HOW + WHEN\n= Execution Schedule"]
    H -->|"defines"| HT
    HT -->|"merged into"| WHT
    W -->|"defines"| WT["WHAT + WHEN\n= Milestone Map"]
    T -->|"defines"| WT
    WT -->|"merged into"| WHT

    style CENTER fill:#1a237e,color:#fff,stroke-width:3px
    style W fill:#1565c0,color:#fff,stroke-width:2px
    style H fill:#2e7d32,color:#fff,stroke-width:2px
    style T fill:#e65100,color:#fff,stroke-width:2px
    style WH fill:#7986cb,color:#fff
    style HT fill:#81c784,color:#fff
    style WT fill:#ffb74d,color:#333
    style WHT fill:#880e4f,color:#fff,stroke-width:3px
...
![ContingencyFactors](Images/ContingencyFactors.png)
